    ...
    return (
        <div className='bg-white cursor-pointer w-56 rounded-lg shadow-lg'>
            ...
            <div className='w-full flex items-center justify-center'>
                <button
                    type='button'
                    className='btn-primary transition duration-300 ease-in-out focus:outline-none focus:shadow-outline bg-slate-600 hover:bg-slate-900 text-white font-normal py-1 px-3 m-1 rounded-lg'
